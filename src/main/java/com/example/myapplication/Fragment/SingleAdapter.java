...
public class SingleAdapter extends DelegateAdapter.Adapter {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View root = LayoutInflater.from(parent.getContext()).inflate(R.layout.banner_item, parent, false);
        return new SingleViewHolder(root);
    }
    ...
    private class SingleViewHolder extends RecyclerView.ViewHolder {
        public SingleViewHolder(View root) {
            super(root);
        }
    }}
